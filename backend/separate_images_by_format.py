#!/usr/bin/env python
"""
Separate images by format - WebP vs others
...
def separate_images_by_format():
    """Separate WebP images from other formats"""
    print("🔄 Starting image format separation...")
            ...
            if file_path.is_file() and file_path.suffix.lower() in ['.jpg', '.jpeg', '.png', '.webp', '.gif', '.svg', '.bmp', '.tif', '.tiff']:
                ...
                try:
                    ...
                    if webp_count % 100 == 0 or other_count % 100 == 0:
                        print(f"   Processed: {webp_count} WebP, {other_count} others...")
...
if __name__ == "__main__":
    try:
        print("🔄 IMAGE FORMAT SEPARATION SCRIPT")
        print("=" * 50)
        
        # Run separation
        stats = separate_images_by_format()
